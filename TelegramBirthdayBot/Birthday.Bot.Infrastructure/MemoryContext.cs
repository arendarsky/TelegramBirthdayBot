...
namespace Birthday.Bot.Infrastructure
{
    public class MemoryContext
    {
        public MemoryContext()
        {
            Stages = new[]
            {
                CreateStageData(1, CreateAssignmentData("Вспомни день, когда история задокументировала тебя, держащую во рту сигарету. Что за вкус был у сигареты?", "Говрят: \"...(ягода) на торте\"", "вишневая", "вишня", "вишенка")),
